...
if (isset($_POST['from'])) {
    ...
    if ($_POST['from'] != "") {
        ...
        // insertamos la cita
        $query = "INSERT INTO agenda VALUES(null,'$titulo','$inicio_normal','$final_normal','$exped','$lug','$regis','$clase','$te','$ce','$inicio','$final','','$nomSer','$servic','$id_ser','$acc')";
        ...
        <a href="http://localhost/Chabely/indexPrin.php"><img style="width: 30px; height:30px; margin:4px;" src="./assets/flecha-izquierda.png" alt=""></a>
            ...
            <div class="row">
                ...
                <div class="pull-right form-inline"><br>
                   ...
                   <a href=<?php print "http://localhost/Chabely/insertar_notas.php?id=".$params['id'];?>><button class="btn btn-success" data-toggle='modal' >Añadir Nota</button></a>
                </div>
            </div>
            <br><br><br>
            <div <?php
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form accion="" method="post">
                            ...
                            <input type="text" required autocomplete="on" name="accion" class="form-control" id="accion" placeholder="Accion Registrada o Cancelada">
